...
class Main: #CRIAÇÃO DA FUNÇÃO PRINCIPAL, QUE CONTERÁ AS DEMAIS FUNÇÕES
    ...
    def __init__(self, saldo = 10000, extrato = 0, numero_saques = 0, tentativas = 0, lista_usuario = [], lista_agcc = []):
        self.saldo = saldo
    ...
    def cadastro(self):
        ...
        def confirmar():
            ...
            confirmacao = input('Digite "S" para confirmar ou "N" para corrigir: ')
    ...
    def ag_cc(self):
        ...
        lista_cc = {}
        if conta.upper() == "N":
            return print('OK - Criar conta corrente')
        else:
            pass
        ...
        def criar_cc(self):
            ...
            self.extracao_dados('Usuário', 'Número da Conta',)
